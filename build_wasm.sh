...
emcc -O3 libViry3DApp.a libViry3D.a libViry3DDep.a -o viry3d.js -s NO_EXIT_RUNTIME=1 -s EXTRA_EXPORTED_RUNTIME_METHODS='["cwrap"]' -s ALLOW_MEMORY_GROWTH=1 --preload-file Assets -s USE_WEBGL2=0
cd ../../
